...
%
% [Updated 08/27/2013, modified for running in batch mode]
% [Updated 08/28/2013, fixing some bugs related to NaN values]
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
directoryName = CURRENTDIRECTORY{1};
saveFileName = CURRENTSAVEFILENAME{1};
...
if (~exist('eset','var'))
    ...
    % it in an ExperimentSet called "eset".  Make sure the .bin files are 
    % all in the same folder if you want to look at more than one.  
    eset = ExperimentSet.fromFiles(directoryName);
    %
...
if (cleanEset)
    ...
    % Don't ask for approval of filtering:
    ecl.askFirst = false;
...
saveFileName = [directoryName '\' saveFileName];
